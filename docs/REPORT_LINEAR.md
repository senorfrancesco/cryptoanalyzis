# Отчёт о реализации линейного криптоанализа шифра ZMAK (Вариант 5)

## 1. Введение
В дополнение к дифференциальному анализу был проведен **Линейный криптоанализ (Linear Cryptanalysis, LC)** шифра ZMAK (Вариант 5).
...
## 4. Выводы
1.  **Уязвимость:** Шифр ZMAK (Вариант 5) крайне неустойчив к линейному криптоанализу. Смещение $2^{-3}$ для 5 раундов — это катастрофическая уязвимость.
