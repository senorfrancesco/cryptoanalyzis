# Отчёт о реализации дифференциального криптоанализа шифра GFN-16 (Вариант 5)

## 1. Объект исследования
Объектом анализа является легковесный блочный шифр GFN-16 (архитектура "Вариант 5"), построенный по схеме **Обобщенной сети Фейстеля 2-го типа (Type-2 GFN)**.
...
## 4. Выводы
1.  **Стойкость шифра:** Криптосистема GFN-16 (Вариант 5) является криптографически слабой. Размер блока 16 бит и неудачный выбор S-блока допускают существование дифференциалов с вероятностью $2^{-2}$ на 5 раундах.
